    ...
    return (
        <div className="pList">
            <div data-aos="fade-down-right" data-aos-easing="linear"
              data-aos-duration="1000" className="pListItem">
                ...
                <div className="pListTitles">
                    <span className='pListTitlesName'>Hotels</span>
                    <span className='pListTitlesHotel'>233 hotels</span>
                </div>
            </div>
            <div data-aos="fade-down-right" data-aos-easing="linear"
              data-aos-duration="800" className="pListItem">
                ...
                <div className="pListTitles">
                    <span className='pListTitlesName'>Apartments</span>
                    <span className='pListTitlesHotel'>2331 hotels</span>
                </div>
            </div>
            <div data-aos="flip-right" data-aos-easing="linear"
              data-aos-duration="1100" className="pListItem">
                ...
                <div className="pListTitles">
                    <span className='pListTitlesName'>Resorts</span>
                    <span className='pListTitlesHotel'>2331 hotels</span>
                </div>
            </div>
            <div data-aos="fade-down-left" data-aos-easing="linear"
              data-aos-duration="800" className="pListItem">
                ...
                <div className="pListTitles">
                    <span className='pListTitlesName'>Villas</span>
                    <span className='pListTitlesHotel'>2331 hotels</span>
                </div>
            </div>
            <div data-aos="fade-down-left" data-aos-easing="linear"
              data-aos-duration="1200" className="pListItem">
                ...
                <div className="pListTitles">
                    <span className='pListTitlesName'>Cabins</span>
                    <span className='pListTitlesHotel'>2331 hotels</span>
                </div>
            </div>
        </div>
