    ...
    <div className="header">
      <div className={type === "list" ? "headerContainer listMode" : "headerContainer"}>
        <div className="headerList">
          <div data-aos="fade-left" data-aos-duration="600" className="headerListItem active">
            <FontAwesomeIcon icon={faBed} />
            <span>Stays</span>
          </div>
          <div data-aos="fade-left" data-aos-duration="800" className="headerListItem">
            <FontAwesomeIcon icon={faPlane} />
            <span>Flights</span>
          </div>
          <div data-aos="fade-left" data-aos-duration="1000" className="headerListItem">
            <FontAwesomeIcon icon={faCar} />
            <span>Car rentals</span>
          </div>
          <div data-aos="fade-left" data-aos-duration="1200" className="headerListItem">
            <FontAwesomeIcon icon={faBed} />
            <span>Attractions</span>
          </div>
          <div data-aos="fade-left" data-aos-duration="1400" className="headerListItem">
        ...
        {type !== "list" &&
          <>
            <h1 data-aos="zoom-in-right" data-aos-duration="1400" className="headerTitle">A lifetime of discounts? It's Genius.</h1>
            <p data-aos="zoom-in-right" data-aos-duration="1700" className="headerDesc"> Get rewarded for your travels – unlock instant savings of 10% or
              more with a free Tripify account</p>
            <button data-aos="flip-left"
              data-aos-easing="ease-out-cubic"
              data-aos-duration="2000" className="headerBtn">Sing In / Register</button>
